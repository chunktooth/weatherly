...
const currentDate = (data) => {
  ...
  timedate.today = data.current_observation
  .observation_time_rfc822.slice(0, 16);
  timedate.time = data.current_observation.
  observation_time_rfc822.slice(16, 22);
...
const currentWeatherCleaner = (data) => {
  ...
  weatherInfo.high = data.forecast.simpleforecast
